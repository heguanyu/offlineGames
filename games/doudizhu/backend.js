...
import { Game, PHASE, legalMoves } from './engine.js';
...
// transport (../mahjong-common/remote-backend.js). When online play is built, supply buildView
// (rebuild a per-seat GameView rotated so HUMAN=0 is the bottom seat) and mapEvent (server event →
// the UI events above). Until then createBackend('remote') wires the transport but the mappers are
// placeholders.
// ---------------------------------------------------------------------------
