...
// The shared tile model + win solver live in ../mahjong-common/engine-core.js;
// this file adds the Tianjin-specific scoring (混儿 wilds, 起和 2番, 捉五/龙/...) and
// the Game state machine on top.
//
...
export * from '../mahjong-common/engine-core.js';
import {
  KINDS, suitOf, isNumberSuit, tileName, freshTiles, shuffle, toCounts, decompose,
  wildKindsFromIndicator,
} from '../mahjong-common/engine-core.js';
